       ...
       <div class="row">
            <div class="col-md-12">
                <div class="card-header bg-primary">
                    ...
                    <a href="my-orders.php" class="btn btn-warning float-end bg-black"><i class="fa fa-reply">Back</i></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            $order_query=$con->query("SELECT o.id as oid,o.tracking_no,o.user_id,oi.*,oi.qty as orderqty,p.*
                             FROM  orders o,order_items oi,product p WHERE o.user_id='$userId' AND oi.order_id=o.id 
